...
class AADGenerator(nn.Module):
    ...
    def forward(self, z_attr, z_id):
        ...
        return torch.tanh(y)  ##activate function tanh is better than sigmoid
...
if __name__ == "__main__":
    ...
    emd = torch.randn((1,512))
    Y, attr = G(input,emd)
    print(Y.size())#torch.Size([1, 3, 256, 256])
    print(len(attr))
    print(attr[0].size()) #torch.Size([1, 1024, 2, 2])
    print(attr[1].size()) #torch.Size([1, 2048, 4, 4])
    print(attr[2].size()) #torch.Size([1, 1024, 8, 8])
    print(attr[3].size()) #torch.Size([1, 512, 16, 16])
    print(attr[4].size()) #torch.Size([1, 256, 32, 32])
    print(attr[5].size()) #torch.Size([1, 128, 64, 64])
    print(attr[6].size()) #torch.Size([1, 64, 128, 128])
    print(attr[7].size()) #torch.Size([1, 64, 256, 256])